...
import com.ustadmobile.ihttp.ext.getCaseInsensitiveOrNull
import com.ustadmobile.ihttp.ext.requirePostfix
 ...
 */
fun StringValues.clientProtocol(): String? {
 ...
 * @receiver IStringValues representing request headers as received by the server
 */
fun StringValues.clientHost(): String? {
    return get("Forwarded")?.let {
        directivesToMap(it)
 ...
 */
fun StringValues.clientProtocolAndHost(
